        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="relative group perspective-1000">
                ...
                <div class="mt-6 text-center">
                    <button onclick="window.print()" class="inline-flex items-center gap-2 text-sm text-teal-600 font-bold hover:text-teal-700 transition">
                ...
                @if($card->perks->count() > 0)
                    <div class="space-y-4">
                        @foreach($card->perks as $perk)
                            <div class="flex items-center gap-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition">
