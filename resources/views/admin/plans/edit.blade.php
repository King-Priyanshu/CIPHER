...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="card">
            <h3 class="text-xl font-bold text-navy mb-6">Edit Subscription Plan</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $plan->name) }}" required
                            class="input-field" placeholder="e.g. Gold Member">
                        @error('name')
                    ...
                    <div>
                        <label for="interval" class="block text-sm font-medium text-navy mb-1.5">Billing Interval</label>
                    ...
                    <div>
                        <label for="trial_days" class="block text-sm font-medium text-navy mb-1.5">Trial Period (Days)</label>
