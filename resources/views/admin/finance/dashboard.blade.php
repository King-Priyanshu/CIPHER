        ...
        <div class="card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-navy mt-1">₹{{ number_format($metrics['total_revenue'] ?? 0, 0) }}
                    </p>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-navy mt-1">
                        ₹{{ number_format($metrics['monthly_revenue'] ?? 0, 0) }}</p>
                </div>
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-navy mt-1">
                        ₹{{ number_format($metrics['pending_payments'] ?? 0, 0) }}</p>
                </div>
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-navy mt-1">₹{{ number_format($metrics['total_refunds'] ?? 0, 0) }}
                    </p>
                </div>
    ...
    <div class="card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.finance.transactions.export.csv') }}"
                        class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors">
                        Export CSV
                    </a>
                    <a href="{{ route('admin.finance.transactions.export.pdf') }}"
                        class="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition-colors">
                        Export PDF
                    </a>
                </div>
            ...
            <div class="p-4 bg-slate-50 rounded-lg border border-slate-200">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('admin.finance.refunds.export.csv') }}"
                        class="px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors">
                        Export CSV
                    </a>
                    <a href="{{ route('admin.finance.refunds.export.pdf') }}"
                        class="px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition-colors">
                        Export PDF
                    </a>
                </div>
